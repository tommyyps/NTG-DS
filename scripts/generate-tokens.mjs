...
const layoutCss = `
  --font-size-doc-page-title: ${semanticSize.heading.h5};
  --font-size-doc-lead: ${semanticSize.body.lg};
  --font-size-doc-nav-link: ${semanticSize.body.sm};
  --font-size-doc-nav-label: ${semanticSize.body.xs};
  --font-size-doc-brand-sub: ${semanticSize.body.lg};
  --font-size-code-block: ${fontSize["12"]};
  --line-height-doc-body: ${lineHeight["15"]};
  ...
  --letter-spacing-doc-label: 0.06em;
`;
